                ...
                <ul className="navbar-nav">
                    <li className="logo">
                        <a href="/dashboard" className="nav-link">
                            <span className="link-text logo-text"><img src="images/logo-stagiaire-tg.png" alt="" /></span>
                    ...
                    <div className="dashboard-profile-box">
                        <span className="avatar-img">
                          <img alt="" src="" className="photo" /> {/* entreprise.logo */}
                        </span>
                        <div className="user-profile-text">
                            <div className="fullname">{/* {candidat.lastname} */}</div>
                            <div className="fullname">{/* {candidat.firstname} */}</div>
                            <div className="user-role">{/* {candidat.lastname} */}</div>
                        </div>
                    </div>
                    <div className="clearfix"></div>
                    <div style={{ fontSize: "20px", color: "white", padding: "15px" }}>Espace <br/> Personnel</div>
                        ...
                        <li className="nav-item">
                            <Link to="/dashboard" className="nav-link">
                                ...
                                <span className="link-text">CV Pro Digital</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link to="/dashboard" className="nav-link">
                                ...
                                <span className="link-text">Mes CV Pros</span>
                            </Link>
                        </li>
                        <li className="nav-item">
                            <a href="/dashboard" className="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span className="link-text">Recherches</span>
                            </a>
                        </li>
                        {/* <li className="nav-item">
